...
For experiments done, insights gained, approaches taken in ASR and Diarization pleaser refer to [documentation](https://github.com/AbdelrhmanElnenaey/ASR_for_egyptian_dialect/tree/main/Documentation) section 
